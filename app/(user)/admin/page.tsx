...
function StatCard({
  ...
  return (
    <div className={`rounded-2xl border border-gray-100 p-5 shadow-sm ring-1 ${ring} ${bg}`}>
...
export default function AdminDashboardPage() {
  ...
  if (loadingAuth) {
    return (
      <main className="min-h-screen bg-gradient-to-b from-purple-50 to-gray-100 px-4 py-12">
        <div className="mx-auto max-w-4xl rounded-2xl border border-gray-200 bg-white p-8 text-center text-gray-600 shadow-sm">
  ...
  const hints = [
    ...
    undefined,
    stats?.usuariosIndisponivel
      ? "No Supabase SQL Editor, cole o arquivo supabase/scripts/COLE_NO_SQL_EDITOR.sql (o conteúdo SQL, não o caminho) e clique Run."
      : "Cadastros no Udiz",
  ];
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 rounded-2xl border border-dashed border-purple-200 bg-purple-50/50 p-5">
